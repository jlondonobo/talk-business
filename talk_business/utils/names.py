...
def get_nta_name(nta_code: str) -> str:
    """Get the name of an NTA from the NTA code."""
    return NTAS.get(nta_code, "Unknown NTA")


def get_county_name(county_fips: str) -> str:
    """Get the name of an NTA from the NTA code."""
    return COUNTIES.get(county_fips, "Unknown COUNTY")
